...
MODEL_NAME = 'ssd_mobilenet_v1_coco_2017_11_17' #'faster_rcnn_resnet101_coco_2017_11_08'
...
PATH_TO_TEST_IMAGES_DIR = 'test_images' # change this directory according to your needs.
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    for image_path in TEST_IMAGE_PATHS:
      ...
      threshold = 0.60  #CWH: set a minimum score threshold of 50%
